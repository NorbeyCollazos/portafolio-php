...
$ModelTecnologias = new Consultas();
$Tecnologias = $ModelTecnologias->getTecnologias();

$ModelProyectos = new Consultas();
        ...
        <div class="row">
          ...
          ?>
              ...
              <div class="col-md-6 col-sm-12 col-lg-4 mb-3" id="portafolio">
                ...
                <div class="bg-image card hover-shadow" style=" height: 300px; cursor: pointer;" onclick="iraDescripcion('views/visitors/descripcion.php?id=<?php echo $Proyecto1['idproyectos'] ?>')">
              ...
              <div class="accordion-body">
                ...
                <div class="row">
                  ...
                  ?>
                      ...
                      <div class="col-md-6 col-sm-12 col-lg-4 mb-3" id="portafolio">
                        <a href="#">
                          <div class="bg-image card hover-shadow" style=" height: 300px; cursor: pointer;" onclick="iraDescripcion('views/visitors/descripcion.php?id=<?php echo $Proyecto['idproyectos'] ?>')">
